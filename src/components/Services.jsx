      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb -5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            {/* Add a generating AI bar in 1st photo at the bottom in the center */}
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2" />
          </div>
          {/* Add 2nd content with photo and responsiveness on different size screens and devices */}
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              <div className="absolute inset-0">
                <img
                  src={service2}
                  className="h-full w-hull object-cover"
                  width={630}
                  height={750}
                  alt="robot"
                />
              </div>
              {/* Add service content for 2nd photo */}
            ...
            {/* Add 3rd content with photo and responsiveness on different size screens and devices */}
